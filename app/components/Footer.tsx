...
const Footer = () => {
  return (
    <div className=" bottom-0 w-full border-t-4 border-black">
      ...
      <div className="py-4 border-t-4 border-black flex justify-center items-center">
        Copyright ©2023 Adeet Tuladhar. All right reserved
      </div>
    </div>
  );
};
